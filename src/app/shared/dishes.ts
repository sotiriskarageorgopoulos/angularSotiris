...
export const DISHES: Dish[] = [
  ...
  },
  {
    ...
    price: '6.99',
    featured: false,
    description: 'Totally dark chocolate with very strong flavor, made with the range of cocoa beans',
    comments: [
      {
        author: 'John Smith',
        comment: 'A different experience!',
        rating: 3,
        date: '2018-06-23T18:10:13.231Z'
      },
      {
        author: 'Anna Dark',
